  ...
  <div class="polygon-body" style="width: 100%">
    <div>
      ...
      <el-dialog
        ...
        >
        <span>请选择标签</span>
          <el-select v-model="markinfo" @change="changeinfo2" filterable placeholder=" " style="width:100px" ref="selectref">
            <el-option
      ...
      <div id="rightdiv">
        ...
        <div class="infopolygon" style="margin-left: 20px">
          ...
          <div :style="{
                ...
                height:160+'px',
                marginTop:10+'px',
                border: b_i === index ? '3px solid #ff0000' : '0px solid #ff0000',
                background:items.color
              }"
              @mousedown="handelClick(items,index)"
              >
              <div style="width:300px;margin-top:10px;display:inline-block">
              <p :style="{
                marginLeft: 30 + 'px',
                marginTop:10 + 'px',
                width:300+'px',
...
export default {
  ...
  methods: {
    ...
    changeinfo3(item,index,item1){//更改已标注对象的类别
    ...
    saveinfo(infoFlag,changeFlag) {
      ...
      let tempArry = {}
      //变为深拷贝
      tempArry.rectangle=JSON.parse(JSON.stringify(this.realrectangleinfoArray))
    ...
    makeRectangleObj(e){
      ...
      ((e.absolutePointer.x !=
        ...
        console.log("dasiogfu890asdguyqehn fbewjkb fwekjb wef e eq")
          ...
          this.makeRectangle();
          console.log("rectanuuuuuuuuuuuuuuuuuuuuuuuuglePoints",this.rectanglePoints)
          console.log("realRectanuuuuuuuuuuuuuuuuuuuuuglePoints",this.realRectanglePoints)
          this.rectangleArray.push(this.rectangle);
          this.allobjArray.push(this.rectangle);
          this.rectangleinfoArray.push({
            x1:this.rectanglePoints[0].x,
    ...
    makeRectangle(){
      ...
      temrectangleA.on("scaled",function(){//缩放大小
        ...
        _this.rectangleinfoArray[_this.rectangleArray.indexOf(this)].x1=this.left
        _this.rectangleinfoArray[_this.rectangleArray.indexOf(this)].y1=this.top
        _this.rectangleinfoArray[_this.rectangleArray.indexOf(this)].x2=this.left+this.width
        _this.rectangleinfoArray[_this.rectangleArray.indexOf(this)].y1=this.top+this.height
        _this.realrectangleinfoArray[_this.rectangleArray.indexOf(this)].x1=this.left/_this.scalewidth
        _this.realrectangleinfoArray[_this.rectangleArray.indexOf(this)].y1=this.top/_this.scaleheight
        _this.realrectangleinfoArray[_this.rectangleArray.indexOf(this)].x2=(this.left+this.width)/_this.scalewidth
        _this.realrectangleinfoArray[_this.rectangleArray.indexOf(this)].y2=(this.top+this.height)/_this.scaleheight
      })
      temrectangleA.on("moved",function(){//移动
        ...
        _this.rectangleinfoArray[_this.rectangleArray.indexOf(this)].y1=this.top
        _this.rectangleinfoArray[_this.rectangleArray.indexOf(this)].x2=this.left+this.width
        _this.rectangleinfoArray[_this.rectangleArray.indexOf(this)].y2=this.top+this.height
        _this.realrectangleinfoArray[_this.rectangleArray.indexOf(this)].x1=this.left/_this.scalewidth
        _this.realrectangleinfoArray[_this.rectangleArray.indexOf(this)].y1=this.top/_this.scaleheight
        _this.realrectangleinfoArray[_this.rectangleArray.indexOf(this)].x2=(this.left+this.width)/_this.scalewidth
        _this.realrectangleinfoArray[_this.rectangleArray.indexOf(this)].y2=(this.top+this.height)/_this.scaleheight
