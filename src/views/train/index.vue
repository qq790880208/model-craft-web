    ...
    <el-dialog title="任务信息" :visible.sync="dialogFormVisible">
      <el-form :model="taskInfo">
        <el-form-item label="任务名称" :label-width="formLabelWidth">
          <el-input v-model="taskInfo.name" autocomplete="off" style="width: 90%"></el-input>
        </el-form-item>
        <el-form-item label="任务描述" :label-width="formLabelWidth">
          <el-input v-model="taskInfo.description" autocomplete="off" style="width: 90%"></el-input>
        </el-form-item>
        <el-form-item label="预置算法" :label-width="formLabelWidth">
          <el-select v-model="taskInfo.algorithm" placeholder="请选择">
        ...
        <el-form-item label="预置模型" :label-width="formLabelWidth">
          <el-select v-model="taskInfo.model" placeholder="请选择">
            <div style="height:150px;" class="scrollbar">
              <el-scrollbar style="height:100%; overflow-x:hidden;">
        ...
        <el-form-item label="数据来源" :label-width="formLabelWidth">
          <el-select v-model="taskInfo.inputdata" placeholder="请选择">
            <div style="height:150px;" class="scrollbar">
              <el-scrollbar style="height:100%; overflow-x:hidden;">
        ...
        <el-form-item label="输出位置" :label-width="formLabelWidth">
          <el-select v-model="taskInfo.outpath" placeholder="请选择">
            <div style="height:150px;" class="scrollbar">
              <el-scrollbar style="height:100%; overflow-x:hidden;">
    ...
    export default {
      ...
      methods:{
        ...
        okbtn1(){//确认创建训练任务
          ...
          this.taskInfo.para = this.paraNameList[this.currentAlgorithm]
          this.taskInfo.paravalue = this.paraValueList[this.currentAlgorithm]
          console.log(this.taskInfo)
          sendTaskInfo(this.taskInfo).then(res => { 
